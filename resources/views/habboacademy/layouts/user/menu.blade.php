<div class="user-menu">
    <a class="button" href="{{ route('topics.create') }}" data-toggle="tooltip" data-placement="left" title="Postar tópico"><i class="fas fa-pencil-alt"></i></a>
    <a class="button" href="{{ route('topics.me') }}" data-toggle="tooltip" data-placement="left" title="Meus tópicos"><i class="fas fa-pen-square"></i></a>
    <a class="button" href="{{ route('users.edit') }}" data-toggle="tooltip" data-placement="left" title="Configurações da Conta"><i class="fas fa-cog"></i></a>
