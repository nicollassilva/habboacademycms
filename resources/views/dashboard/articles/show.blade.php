...
<a href="{{ route('adm.articles.index') }}" class="btn btn-danger">
    <i class="fas fa-chevron-left mr-1"></i> Voltar
</a>
<a href="{{ route('adm.articles.edit', $article->id) }}" class="btn btn-dark">
...
<div class="card">
    ...
    <div class="card-footer">
        <form action="{{ route('adm.articles.destroy', $article->id) }}" method="POST" id="deleteForm">
            @csrf
            @method('DELETE')
